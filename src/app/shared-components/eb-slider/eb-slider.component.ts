...
@Component({
  selector: 'eb-slider',
  templateUrl: './eb-slider.component.html',
  styleUrls: ['./eb-slider.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class EbSliderComponent implements OnInit, ControlValueAccessor {
  ...
  get containerClass() {
    let tooltipClass = this.showTooltip ? 'eb-slider-tooltip-container' : '';
    return tooltipClass;
  }
