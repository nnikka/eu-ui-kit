...
@Component({
  ...
  styleUrls: ['./eb-checkbox.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class EbCheckboxComponent implements OnInit, ControlValueAccessor {
  ...
  get checkboxClass() {
    let disabledClass = this.disabled ? 'eb-checkbox-disabled' : '';
