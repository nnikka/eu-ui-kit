...
@Component({
  ...
  templateUrl: './eb-textarea.component.html',
  styleUrls: ['./eb-textarea.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class EbTextareaComponent implements OnInit, ControlValueAccessor {
  @Input() label: string;
  ...
  get txtareaClass() {
    let errorClass = this.showError ? 'eb-txtarea-error-txtarea' : '';
    let txtAreaOpenedClass = this.value ? 'eb-txtarea-opened' : '';
